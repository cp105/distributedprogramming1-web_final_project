...
<?php
    ...
    echo "<tr><td>Total number of free seats</td> <td>$seats_free</td></tr>";
    ...
    echo "<tr><td>Total number of reserved seats</td> <td>$seats_reserved</td></tr>";

    $seats_purchased = $seats_num - $seats_free - $seats_reserved;
    echo "<tr><td>Total number of purchased seats</td> <td>$seats_purchased</td></tr>";
    echo "</table>" ;
    echo "</div>";
